...
# Configurar a página no modo wide para ocupar toda a largura disponível
...
@st.cache_data
def load_data():
    url = 'assets/dados_filtrados.parquet'
...
if analise_tipo == "Razão Social":
    ...
    # Calcular os estados com maiores valores de área, número de seguros e valor total
    ...
    # Menu lateral para o tipo de análise e análise explanatória
    with st.sidebar:
            st.markdown(
    ...
    # Criar um gráfico de barras com a métrica selecionada
    fig_bar = px.bar(
  ...
  # Cálculo das métricas para os cartões
    ...
    # Exibir o mapa de Valor Total Assegurado e gráfico de pizza lado a lado
